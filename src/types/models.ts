...
export interface UserProfile {
  ...
  /** Opt-in for push notifications carrying the daily AI coaching nudge. */
...
export type NudgeTone = 'celebratory' | 'encouraging' | 'concerned' | 'neutral';

/** Server-generated by the generate-nudges Edge Function — read-only from the client. */
...
/** Server-generated by the generate-reflections Edge Function — read-only from the client. */
export interface AiReflection {
  ...
  /** Pulled from context_snapshot.totals — the same numbers fed to the prompt. */
