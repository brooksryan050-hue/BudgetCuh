...
const FEATURES = ['Unlimited AI receipt scanning', 'Priority support', 'One subscription, every future perk'];
  ...
  useEffect(() => {
    getCurrentOffering()
      .then((offering) => {
        ...
        setSelectedId(offering?.annual?.identifier ?? available[0]?.identifier ?? null);
      })
